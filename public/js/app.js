...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var stripe, card, mountWidget, paymentType, placeOrder, paymentForm;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            placeOrder = function _placeOrder(formObject) {
            ...
            _context.next = 4;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_3__["loadStripe"])('pk_test_51LQ7ylSDsctXpDq1HJIQZSC1iBPdl97Xox7WMSZNORgBn0u4xp9f7UpuxRYQUQoeBVmxz6uGlybKWnX75xAxzy6E00jHEQGmao');
